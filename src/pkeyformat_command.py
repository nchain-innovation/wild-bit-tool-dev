    ...
    def format_key(self, private_key):
        ...
        try:
            ...
            if in_format == 'wif':
                ...
                myPrivKey = PrivateKey.from_hex(private_key, network=self.key_type)
            elif in_format == 'int':
                myPrivKey = PrivateKey.from_int(int(private_key), network=self.key_type)
        ...
        if out_format == 'wif':
            print('\n------------------------------------------------------------------------------------')
            print('Private Key (wif) \t-> ', key_to_wif(myPrivKey))
            print('------------------------------------------------------------------------------------\n')
